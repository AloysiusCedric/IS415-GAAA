...
-   `CostalOutline`, a polygon feature data showing the national boundary of Singapore. It is provided by SLA and is in ESRI shapefile format. (This data needs to be derived ourselves using  *st_union* or *st_combine()* and to transform tibble data.frame, we need to use st_transform()
...
Combining to get the coastal line
