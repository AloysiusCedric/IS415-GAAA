...
## **1.3 A short note about GWmodel**
...
```{r}
# i want to fix my mpsz_svy21 invalid polygons
...
The code chunks below is used to create a point symbol map.
...
The code chunks below is used to create a point symbol map of the coefficient estimates.
